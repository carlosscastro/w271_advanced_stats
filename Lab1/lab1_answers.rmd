...
a = c(20:100)
y_dem_nw = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a)/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a))

y_oth_nw = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[3])/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[3]))

y_rep_nw = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[4])/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[4]))



y_dem_w = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                glm.out$coefficients[5])/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                glm.out$coefficients[5]))

y_oth_w = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[3] +
                glm.out$coefficients[5])/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[3] +
...
y_rep_w = exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[4] +
                glm.out$coefficients[5])/
       (1+exp(glm.out$coefficients[1] + glm.out$coefficients[2]*a +
                 glm.out$coefficients[4] +
