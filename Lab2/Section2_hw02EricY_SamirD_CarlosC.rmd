...
## Section 3
Key Predictors of 2016 Contribution
The NextDegreeBinary -  This variable indicates whether an individual obtained an advanced degree.  We see a statistically significant increase when individuals in our sample set  have an advanced degree.  Having an advanced degree increases the prob of contribution by x....
...
mn.out1 <- multinom(FY16cat ~ AttendenceEvent + Gender + Class.Year  + Marital.Status + NextDegreeBinary + FY12Giving + FY13Giving + FY14Giving + FY15Giving, data=labdata)
summary(mn.out1)
Anova(mn.out1)

#Prediction
mn.out1 <- multinom(FY16cat ~ AttendenceEvent + YearsSinceGrad  +
