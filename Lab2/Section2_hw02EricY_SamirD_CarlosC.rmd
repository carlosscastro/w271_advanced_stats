...
```{r}
parallel.columns <- c("Gender", "Marital.Status", "AttendenceEvent","FY12Giving", "FY13Giving", "FY14Giving", "FY15Giving", "YearsSinceGrad", "meandonation", "NextDegreeBinary")
ggparcoord(labdata, columns = parallel.columns, order = 1:length(parallel.columns), groupColumn = "FY16cat", scale = "uniminmax", scaleSummary = "center", title = "FY16GivingCat: Parallel Coordinate Plot") + theme(axis.text.x = element_text(angle = 90))
```
