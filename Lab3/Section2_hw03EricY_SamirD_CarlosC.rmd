...
df2 <- data.frame(time=index(amaz.close), n=amaz.close$TwentyDayRolling, Value="20-day Rolling Mean", size=2)
colnames(df2) <- c("time", "n", "Value", "size")
df3 <- data.frame(time=index(amaz.close), n=amaz.close$FiftyDayRolling, Value="50-day Rolling Mean", size=2) 
